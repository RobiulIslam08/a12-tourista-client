  ...
  return (
    <section className="py-6 md:py-8 lg:py-10 px-4 sm:px-6 lg:px-8 bg-gray-100 text-gray-800 dark:bg-gray-900 dark:text-white">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="text-center mb-16">
          <span className="bg-emerald-100 text-emerald-600 dark:bg-emerald-500/20 dark:text-emerald-400 px-3 py-1 rounded-full text-sm mb-4 inline-block">
            Why Choose Tourista
          </span>
          <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 dark:text-white mb-4">Your Trusted Travel Partner in Bangladesh</h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          {stats.map((stat, index) => (
            <div key={index} className="text-center">
              <div className="bg-white rounded-xl p-6 border border-gray-200 hover:border-emerald-500/50 transition-colors dark:bg-gray-800 dark:border-gray-700">
                <h3 className="text-3xl md:text-4xl font-bold text-emerald-600 dark:text-emerald-400 mb-2">{stat.number}</h3>
                <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-1">{stat.label}</h4>
                <p className="text-gray-600 text-sm dark:text-gray-400">{stat.description}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {features.map((feature, index) => (
            <div
              key={index}
              className="bg-white border border-gray-200 hover:border-emerald-500/50 transition-all duration-300 group hover:transform hover:scale-105 rounded-lg dark:bg-gray-800 dark:border-gray-700"
            >
              <div className="p-6">
                <div className="flex items-center mb-4">
                  <div className="p-3 rounded-xl bg-gray-200 group-hover:bg-gray-300 transition-colors mr-4 text-emerald-600 dark:bg-gray-700 dark:group-hover:bg-gray-600 dark:text-emerald-400">
                    {getIcon(feature.icon)}
                  </div>
                  <span className="bg-emerald-100 text-emerald-600 px-2 py-1 rounded-md text-xs dark:bg-emerald-500/20 dark:text-emerald-400">
                    {feature.highlight}
                  </span>
                </div>

                <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-emerald-600 transition-colors dark:text-white dark:group-hover:text-emerald-400">
                  {feature.title}
                </h3>
        ...
        {/* Certifications Section (Optional - if you want to add this back) */}
        {/* <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-8">Our Certifications</h2>
