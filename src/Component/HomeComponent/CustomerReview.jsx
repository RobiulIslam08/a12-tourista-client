...
export default function CustomerReviews() {
  ...
  const renderStars = (rating) => {
    return Array.from({ length: 5 }, (_, i) => (
      <svg
        key={i}
        className={`h-4 w-4 ${i < rating ? "fill-yellow-500 text-yellow-500" : "text-gray-400 dark:text-gray-600"}`}
        fill="currentColor"
        viewBox="0 0 20 20"
      >
        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
  ...
  return (
    <section className="py-6 md:py-8 lg:py-10 px-4 sm:px-6 lg:px-8 bg-gray-100 text-gray-800 dark:bg-gray-900 dark:text-white">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="text-center mb-16">
          <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 dark:text-white mb-4">What Our Travelers Say</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {stats.map((stat, index) => (
              <div key={index} className="text-center">
                <div className="flex items-center justify-center mb-2">
                  <svg className="h-6 w-6 text-emerald-600 dark:text-emerald-400 mr-2" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                  </svg>
        ...
        <div className="relative mb-16">
          <div className="bg-white border border-gray-200 rounded-lg overflow-hidden dark:bg-gray-900 dark:border-gray-700">
            <div className="p-8 md:p-12">
              <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="flex-1">
                  <div className="flex items-center mb-6">
                    <svg className="h-8 w-8 text-emerald-600 dark:text-emerald-400 mr-4" fill="currentColor" viewBox="0 0 20 20">
                      <path
                        fillRule="evenodd"
                        d="M3 17a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM6.293 6.707a1 1 0 010-1.414l3-3a1 1 0 011.414 0l3 3a1 1 0 01-1.414 1.414L11 5.414V13a1 1 0 11-2 0V5.414L7.707 6.707a1 1 0 01-1.414 0z"
                        clipRule="evenodd"
                  ...
                  <blockquote className="text-xl md:text-2xl text-gray-800 leading-relaxed mb-6 dark:text-gray-200">
                    "{reviews[currentReview].review}"
                  </blockquote>
                    ...
                    <div className="flex gap-3 mb-6">
                      {reviews[currentReview].images.map((image, index) => (
                        <img
                          ...
                          src={image || "/placeholder.svg"}
                          alt={`Trip photo ${index + 1}`}
                          className="w-20 h-20 rounded-lg object-cover border-2 border-gray-300 dark:border-gray-700"
                        />
                      ))}
                    </div>
                  )}
                  ...
                  <div className="flex flex-wrap gap-4 mb-6">
                    ...
                    <span className="bg-emerald-100 text-emerald-600 px-2 py-1 rounded-md text-sm dark:bg-emerald-500/20 dark:text-emerald-400">
                      {reviews[currentReview].tripType}
                    </span>
                  </div>
                </div>
                ...
                {/* Reviewer Info */}
                <div className="lg:w-80">
                  <div className="bg-gray-50 rounded-xl p-6 dark:bg-gray-800">
                    <div className="flex items-center mb-4">
                      <img
                        src={reviews[currentReview].avatar || "/placeholder.svg"}
                        alt={reviews[currentReview].name}
                      ...
                      <div>
                        <div className="flex items-center">
                          <h4 className="text-lg font-semibold text-gray-900 dark:text-white mr-2">{reviews[currentReview].name}</h4>
                          {reviews[currentReview].verified && (
                        ...
                        <p className="text-gray-600 text-sm dark:text-gray-400">{reviews[currentReview].location}</p>
                        <p className="text-gray-500 text-xs dark:text-gray-500">{reviews[currentReview].date}</p>
                      </div>
                    </div>
                    ...
                    <div className="text-center pt-4 border-t border-gray-200 dark:border-gray-700">
                      ...
                      <button className="border border-gray-300 text-gray-700 hover:bg-gray-100 bg-transparent px-4 py-2 rounded-md text-sm transition-colors dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-700">
                        Helpful
                      </button>
                    </div>
                  </div>
          ...
          <div className="flex justify-center mt-8 gap-4">
            <button
              onClick={prevReview}
              className="border border-gray-300 text-gray-700 hover:bg-gray-100 bg-transparent p-2 rounded-md transition-colors dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-800"
            >
              <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
              </svg>
            ...
            <div className="flex items-center gap-2">
              {reviews.map((_, index) => (
                <button
                  ...
                  onClick={() => setCurrentReview(index)}
                  className={`w-3 h-3 rounded-full transition-colors ${
                    index === currentReview ? "bg-emerald-600 dark:bg-emerald-400" : "bg-gray-400 dark:bg-gray-600"
                  }`}
                />
              ))}
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {reviews.slice(0, 3).map((review) => (
            <div key={review.id} className="bg-white border border-gray-200 rounded-lg dark:bg-gray-900 dark:border-gray-700">
              <div className="p-6">
                <div className="flex items-center mb-4">
                  <img
                    src={review.avatar || "/placeholder.svg"}
                  ...
                  <div className="flex-1">
                    <div className="flex items-center">
                      <h4 className="font-semibold text-gray-900 dark:text-white mr-2">{review.name}</h4>
                      {review.verified && (
                ...
                <p className="text-gray-700 text-sm mb-4 line-clamp-4 dark:text-gray-300">{review.review}</p>
